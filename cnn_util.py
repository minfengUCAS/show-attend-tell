...
deploy = '/home/minfeng.zhan/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/home/minfeng.zhan/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
mean = '/home/minfeng.zhan/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
...
class CNN(object):
    ...
    def get_features(self, image_list, layers='fc7', layer_sizes=[4096]):
        ...
        for start, end in zip(range(0, iter_until, self.batch_size), \
            ...
            print("Generate Image feature from ", start, " to ", end)
