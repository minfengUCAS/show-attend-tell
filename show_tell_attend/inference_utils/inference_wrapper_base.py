...
class InferenceWrapperBase(object):
  ...
  def caption_generator(self, sess, model, encode_image, input_feed):
    """Runs inference of show_attend_tell

    :param sess: Tensorflow Session object
    :param model: show_attend_tell object
    :param encode_image: An ecoded image string
    :param input_feed: A numpy array of shape [batch_size]
    :return: A numpy of word idx
    """
    tf.logging.fatal("Please implement caption_generator in subclass")
